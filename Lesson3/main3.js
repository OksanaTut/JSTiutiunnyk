...
//     document.write(`<div>Just do it </div>`);
// }
...
//             <h3 class="product-title">${product.title} - ціна ${product.price} грн</h3>
...
document.write(`<ul> Status false:`)
for (const user of users) {
